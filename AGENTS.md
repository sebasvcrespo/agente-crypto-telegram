...
- Recorre los 11 pares (`INTERNAL_MULTI_STRATEGY_LIST`): **BTC/USDT** (el primero, par directo USDT) y los demás base BTC: XRP, ADA, ORDI, LINK, SUI, DOGE, SOL, PAXG, ETH, BNB (`/BTC`).
